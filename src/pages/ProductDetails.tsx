...
import {
  Star, Heart, ShoppingCart, ShieldAlert, ArrowLeft,
  HardDrive, FileCode, Users, Award, MessageSquare, Plus, Calendar
} from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto space-y-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="col-span-1 lg:col-span-7 space-y-4">
            ...
            <div className="flex gap-3 overflow-x-auto pb-1">
              {gallery.map((img, idx) => (
                <button
                  ...
                  className={`relative w-23 aspect-[4/3] rounded-xl overflow-hidden bg-slate-950 border-2 transition-all cursor-pointer flex-shrink-0 ${
            ...
            <div className="p-4 rounded-xl border border-white/5 bg-slate-900/30 flex items-start gap-3 mt-6">
          ...
          <div className="col-span-1 lg:col-span-5 space-y-6">
            ...
            <div className="grid grid-cols-2 gap-3 bg-slate-900/20 border border-white/5 rounded-2xl p-4 text-xs font-sans">
            ...
            <div className="space-y-2 border-t border-white/5 pt-4">
              ...
              <ul className="text-xs text-slate-400 space-y-2">
                {product.features.map((feat, i) => (
                  <li key={i} className="flex sm:items-start gap-2 leading-relaxed">
        ...
        <section className="border-t border-white/8 pt-10 space-y-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
              ...
              {reviews.length === 0 ? (
                ...
                reviews.map((rev) => {
                  ...
                  return (
                    <div
                      key={rev.id}
                      className="p-4 rounded-xl border border-white/5 bg-slate-900/30 space-y-3 mt-1 leading-relaxed"
                    >
            ...
            <div className="col-span-1 lg:col-span-5">
              <div className="rounded-xl border border-white/8 bg-slate-900/50 p-5 space-y-4">
                ...
                <form onSubmit={handleReviewSubmit} className="space-y-4">
                  ...
                  <div className="space-y-1.5">
                    <label className="text-[10px] font-bold text-slate-400 uppercase tracking-widest block font-mono">Client Rating</label>
                    <div className="flex items-center gap-1">
                      {[1, 2, 3, 4, 5].map((star) => (
                        <button
                          key={star}
                  ...
                  {/* Comment message */}
                  <div className="space-y-1.5">
                    <label className="text-[10px] font-bold text-slate-400 uppercase tracking-widest block font-mono">Detailed Comments</label>
                    <textarea
                      value={userComment}
                      onChange={(e) => setUserComment(e.target.value)}
                      className="w-full px-3 py-2 bg-slate-950 border border-white/10 rounded-lg text-xs placeholder-slate-500 text-white focus:outline-none focus:border-brand-purple"
                      rows={4}
